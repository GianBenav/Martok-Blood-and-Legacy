...
Objeto crearObjetoBase()
{
    ...
    objeto.varianteArma =
        VarianteArma::Ninguna;

    objeto.varianteEscudo =
        VarianteEscudo::Ninguno;

    objeto.varianteArmadura =
        VarianteArmadura::Ninguna;

    objeto.varianteRopa =
        VarianteRopa::Ninguna;

    objeto.varianteJoya =
        VarianteJoya::Ninguna;
...
)
{
    ...
    switch (variante)
    {
        ...
        case VarianteArmadura::ArmaduraDePlacas:
            ...
            objeto.defensaCorte = 80;
            objeto.defensaPerforacion = 60;
            objeto.defensaGolpe = 70;
            objeto.sigilo = -10;
        ...
        case VarianteArmadura::ArmaduraDePlacasPesada:
            ...
            objeto.defensaCorte = 95;
            objeto.defensaPerforacion = 80;
            objeto.defensaGolpe = 85;
            objeto.sigilo = -15;
        ...
        case VarianteArmadura::ArmaduraDeGuerra:
            ...
            objeto.defensaCorte = 100;
            objeto.defensaPerforacion = 90;
            objeto.defensaGolpe = 95;
            objeto.sigilo = -20;
...
)
{
    ...
    double modificadorMaterial =
        (
            ...
            propiedades.flexibilidad * 0.45 +
            propiedades.dureza * 0.20
        ) / 100.0;
...
)
{
    ...
    switch (variante)
    {
        ...
        case VarianteJoya::AmuletoSimple:
            ...
            objeto.defensa = 3;
            objeto.resistenciaEnfermedades = 2;
